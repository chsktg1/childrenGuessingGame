...
class Game extends Component {
  ...
  activeImages = () => {
    ...
    return imagesList.filter((e) => e.category === activeTab);
  };

  updateState = (event) => {
    const tabId = tabsList.filter(
      (e) => e.displayText === event.target.innerText
    )[0]["tabId"];
    ...
    return (
      <>
        ...
        <div className="tabs-container">
          ...
          <p
            className={activeTab === "ANIMAL" ? "active-tab" : null}
            onClick={this.updateState}
          >
            Animals
          </p>
          <p
            className={activeTab === "PLACE" ? "active-tab" : null}
            onClick={this.updateState}
          >
            Places
          </p>
